...
class _mainPageState extends State<mainPage> {
  ...
  // Add the _showLocationServiceDialog method here
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              double maxHeight = keyboardHeight > 0
                  ...
                  : 550;
              double minHeight = keyboardHeight > 0 ? 250 : 135;
                  ...
                  children: [
                    FlutterMap(
                      ...
                      children: [
                        TileLayer(
                          urlTemplate:
                          'https://api.mapbox.com/styles/v1/kctiru/cm2c3cdhl009l01poc7xihjc7/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1Ijoia2N0aXJ1IiwiYSI6ImNtMmVhaGxnczBzMmMya3NiZTNmYmc0NGsifQ.X4OpU9Ajb6UvH4DOPneHig',
                          maxNativeZoom: 22,
                        ),
                        LocationMarkerLayer(
...
//                   ? constraints.maxHeight - keyboardHeight * 0.5
//                   : 550;
//               double minHeight = keyboardHeight > 0
//                   ? 250 : 135;
//               return SlidingUpPanel(
//                 minHeight: minHeight,
//                 maxHeight: maxHeight,
...
//                           alignment: Alignment.center,
//                           onPressed: () =>
//                               _screenKey.currentState?.openDrawer(),
//                         ),
//                       ),
//                     ),
//                     Positioned(
